    ...
    <div className="app-landing">
      <div className="app-landing__text">
        ...
        <div className="app-landing__links">
          <a href="https://apps.apple.com/us/app/zelos-team-management/id1441089536" target="_blank" rel="noopener noreferrer">
            <AppStore className="app-landing__link"/>
          </a>
          <a href="https://play.google.com/store/apps/details?id=com.zelos.client&hl=en" target="_blank" rel="noopener noreferrer">
            <PlayStore className="app-landing__link" />
          </a>
        </div>
      </div>
      <img className="app-landing__img" src={mobileApplication} alt="mobileApplication" />
    </div>
  )
}
